...
const activities = [
  {
    id: 1,
    type: "enrollment",
    message: "32 new students enrolled in Web Development batch",
    location: "Peshawar Center",
    time: "2 hours ago",
    icon: UserPlus,
  ...
  },
  {
    id: 3,
    type: "completion",
    message: "Batch #BQKPK-001 completed Phase 1 training",
    location: "Mardan",
    time: "6 hours ago",
    icon: CheckCircle,
